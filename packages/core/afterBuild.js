 ...
 * same build error as packages/components related to @lun-web/core
 */
const indexContent = fs.readFileSync('./dist/index.d.ts', { encoding: 'utf8' });
fs.writeFileSync('./dist/index.d.ts', indexContent.replace(/'.+LUNUTILS'/g, `'@lun-web/utils'`), { encoding: 'utf8' });
