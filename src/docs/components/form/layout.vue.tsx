...
export default () => (
  <>
    <h3>grid布局</h3>
    <l-form instance={instance} {...pick(instance.data, ['cols', 'labelLayout', 'preferSubgrid'])}>
      ...
      <l-form-item name="input3" label="label3" element="input" colSpan={2} newLine={instance.data.label3NewLine} />
      <l-form-item name="input4" label="label4" element="input" />
    </l-form>
    <h3>flex布局</h3>
    <l-form layout="flex" instance={instance} {...pick(instance.data, ['cols', 'labelLayout', 'preferSubgrid'])}>
      <l-form-item name="labelLayout" label="标签布局" fullLine>
        <l-radio-group options={options} />
      </l-form-item>
      <l-form-item name="cols" label="列数" type="number" element="input" />
